package com.example.a37046.zyfypt_707_zt.fragments.videofragment;
...
import com.example.a37046.zyfypt_707_zt.model.SpecialVideoModel;
...
public class SpecialVideoFragment extends BaseFragment{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return  inflater.inflate(R.layout.fragment_video_special,container,false);
    }
    @Override//生命周期方法，View创建完成
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        initRecyclerView(view);
        SpecialVideoModel specialVideoModel=new SpecialVideoModel();
        specialVideoModel.getResultList("video",page,getSessionId(), listener);
    }

    private void initRecyclerView(View view) {
        recyclerView=view.findViewById(R.id.fragment_video_special_rec);
