...
public class CSampleModel implements CollectListiface<SampleBean> {
    ...
    @Override
    public void getResultList(String mod, int page, String sessionID, final CollectListListener<SampleBean> listener) {
        //使用Retrofit----2
        CollectListService service
                =retrofit.create(CollectListService.class);
        Call<List<CollectBean<SampleBean>>> call =
                service.getCTcaseList(mod, page, sessionID);
        //使用Retrofit----3
        call.enqueue(new Callback<List<CollectBean<SampleBean>>>() {
            @Override
            public void onResponse(Call<List<CollectBean<SampleBean>>> call, Response<List<CollectBean<SampleBean>>> response) {
            ...
            @Override
            public void onFailure(Call<List<CollectBean<SampleBean>>> call, Throwable t) {
