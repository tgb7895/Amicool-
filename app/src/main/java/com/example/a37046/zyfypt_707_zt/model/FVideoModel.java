...
public class FVideoModel implements ConcernListiface<VideoBean> {
    ...
    @Override
    public void getResultList(String mod, int page, String sessionID, int userid, final ConcerListListener<VideoBean> listener) {
        ConcernListsService concernListsService = retrofit.create(ConcernListsService.class);
        Call<List<VideoBean>> call = concernListsService.getVideoList(mod, page, sessionID, userid);
