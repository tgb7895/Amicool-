...
import com.example.a37046.zyfypt_707_zt.fragments.samplefragment.CaseSampleFragment;
import com.example.a37046.zyfypt_707_zt.fragments.samplefragment.ItemSampleFragment;
...
public class SampleFragment extends BaseFragment {
    ...
    private CaseSampleFragment caseSampleFragment = null;
    private ItemSampleFragment itemSampleFragment = null;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        viewpager = (ViewPager) view.findViewById(R.id.fragment_sample_view_pager);
        viewpager.setAdapter(new MyPagerAdapter(getChildFragmentManager()));
        pagersliding = (PagerSlidingTabStrip) view.findViewById(R.id.fragment_sample_strip);
    ...
    private class MyPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) { //根据位置返回具体某个导航上对应的Fragment
            switch (position) {
                case 0:
                    if (caseSampleFragment == null) {
                        caseSampleFragment = new CaseSampleFragment();
                    }
                    return caseSampleFragment;
                case 1:
                    if (itemSampleFragment == null) {
                        itemSampleFragment = new ItemSampleFragment();
                    }
                    return itemSampleFragment;
                default:
                    return null;
            }
        }
